...
<html lang="pl-PL">
	...
	<title>Zaloguj się &lsaquo; Parafia Św. Mikołaja w Miszewku Strzałkowskim &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.1.1" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://127.0.0.1/wordpress/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Zaloguj się">
					...
					<p id="nav">
				<a href="./?action=lostpassword">Nie pamiętasz hasła?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Przejdź do Parafia Św. Mikołaja w Miszewku Strzałkowskim</a>		</p>
			</div>
...
<script src="./wp-content/plugins/gutenberg/build/vendors/inert-polyfill.min.js?ver=6.1.1" id="wp-inert-polyfill-js"></script>
<script src="./wp-includes/js/dist/vendor/wp-polyfill.min.js?ver=3.15.0" id="wp-polyfill-js"></script>
<script src="./wp-content/plugins/gutenberg/build/hooks/index.min.js?ver=b68e9bf6562f8d63a320" id="wp-hooks-js"></script>
<script src="./wp-content/plugins/gutenberg/build/i18n/index.min.js?ver=3d2aeabd3f84698c0e2c" id="wp-i18n-js"></script>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"f884da3904"};</script>
